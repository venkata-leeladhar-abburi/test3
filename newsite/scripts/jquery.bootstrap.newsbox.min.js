...
if (typeof Object.create !== "function") {
    ...
    var i = {
        ...
        buildNavigation: function() {
            ...
            if (t) {
                var n = '<ul class="pagination pull-right" style="margin: 0px;">' + '<li><a href="#" class="prev"><span class="glyphicon glyphicon-chevron-down"></span></a></li>' + '<li><a href="#" class="next"><span class="glyphicon glyphicon-chevron-up"></span></a></li>' + '<li><a href="Institute.php?view=MoreUpdates"><span class="">More..</span></a></li>' + '</ul><div class="clearfix"></div>';
